...
The sequences are captured as rosbags, which are then compressed with bz2 method. We also split the data into different bags based on the sensor type. User can freely select the combo that suits their interest.
